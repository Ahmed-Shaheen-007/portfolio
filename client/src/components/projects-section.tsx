    ...
    <section id="projects" className="py-20 bg-background">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto" data-testid="projects-description">
          ...
          {projects.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-foreground mb-3" data-testid={`project-title-${project.title.toLowerCase().replace(/\s+/g, '-')}`}>
                    {project.title}
                  </h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tools.map((tool, toolIndex) => (
                        <span 
                          ...
                          data-testid={`project-tool-${tool.name.toLowerCase().replace(/\s+/g, '-')}`}
                        >
                          {tool.name}
                        </span>
                      ))}
                  ...
                  <div className="flex space-x-4">
                    ...
                    <button 
                      ...
                      data-testid={`button-source-code-${index}`}
                    >
                      <Github size={14} />
